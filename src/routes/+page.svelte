...
<style>
  ...
  .workspace-loading strong { margin-top: 19px; font-size: var(--text-title); letter-spacing: -.02em; }
  .workspace-loading span { margin-top: 6px; color: #74747c; font-size: var(--text-control); }
