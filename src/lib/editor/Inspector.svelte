...
<style>
  .inspector { position: absolute; z-index: 30; inset: 0 0 0 auto; width: var(--right-panel-width,241px); background: #292929; border-left: 1px solid #444; display: flex; flex-direction: column; }.top-controls { height: 42px; border-bottom: 1px solid #3d3d3d; display: flex; align-items: center; padding: 0 7px 0 11px; gap: 8px; }.avatar { width: 24px; height: 24px; border-radius: 50%; background: #64748b; display: grid; place-items: center; font-size: var(--text-control); }.top-controls .play { margin-left: auto; background: transparent; border: 0; color: #eee; width: 31px; height: 29px; display: grid; place-items: center; border-radius: 5px; cursor: pointer; }.top-controls .play:hover { background: #3b3b3b; }.top-controls .export { height: 27px; border: 0; border-radius: 5px; background: #0d99ff; color: white; padding: 0 10px; font-size: var(--text-small); font-weight: var(--weight-semibold); cursor: pointer; }
